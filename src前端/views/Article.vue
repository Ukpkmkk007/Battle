<template>
    <div>
        ...
        <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
            ...
            <el-table-column prop="name" label="比赛小组"></el-table-column>
            <el-table-column prop="content" label="比赛结果">
                <template slot-scope="scope">
                    <el-button @click="view(scope.row.content)" type="primary">查看内容</el-button>
                </template>
            </el-table-column>
            <el-table-column prop="user" label="裁判"></el-table-column>
        ...
        <el-dialog title="比赛小组" :visible.sync="dialogFormVisible" width="60%">
        ...
        <el-dialog title="比赛信息" :visible.sync="viewDialogVis" width="60%">
            <el-card>
                <div>
                    <mavon-editor
                            class="md"
